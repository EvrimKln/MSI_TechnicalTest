...
namespace ValuationApi.Services.ValuationServices
{
    public class DryBulkValuation : IValuation
    {
        ...
        private const double S_CO_2 = 0.002;
        ...
        {
            return vessel.VesselTypeId.Equals(DRY_BULK_TYPE);
        }
        ...
        public List<Valuation> CalculateValuation(Vessel vessel, IEnumerable<TimeSeries> timeSeries)
        {
            try
            {
                ...
                foreach (var item in timeSeries)
                {
                    ...
                    valuation.VesselTypeId = DRY_BULK_TYPE;
